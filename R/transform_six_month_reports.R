...
transform_six_month_reports <- function(six_month_reports) {
    ...
    tic()
    transformed_reports <- imap(six_month_reports2[1:200], function(x, y){
        
        print(y)
        
        # diseases present ---------------------------------------------------------
        
       out <- map(c("occCodePresentDiseaseList", "occCodeAbsentDiseaseList"), function(xx){
